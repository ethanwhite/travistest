...
curl -v -i -X POST -H "Content-Type:application/json" -H "Authorization: token $GITHUB_RELEASE_TOKEN" https://api.github.com/repos/ethanwhite/travistest/releases -d "{\"tag_name\":\"$current_date\"}"
